...
async function cargarProductos() {
  ...
  const productosDB = await leerProductosDB();
  ...
  if (productosDB.length > 0) {
    ...
    mensajeEl.textContent = 'Cargado desde IndexedDB';
    return;
  }
  try {
...
const forzarBtn = document.getElementById('forzarUpdate');
